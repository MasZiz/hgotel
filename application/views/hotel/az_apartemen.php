                ...
                <div class="row">
                    <div class="col-md-12 room">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="room-img">
                                    <img src="<?= base_url();?>/img/room/room-1.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="room-des">
                                    ...
                                    <div class="room-link">
                                        ...
                                        <a href="<?= base_url('userkojez/index');?>">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 room">
                        <div class="row">
                            <div class="col-md-6 d-block d-md-none">
                                <div class="room-img">
                                    <img src="<?= base_url();?>/img/room/room-2.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="room-des">
                    ...
                    <div class="col-md-12 room">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="room-img">
                                    <img src="<?= base_url();?>/img/room/room-3.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="room-des">
                    ...
                    <div class="col-md-12 room">
                        <div class="row">
                            <div class="col-md-6 d-block d-md-none">
                                <div class="room-img">
                                    <img src="<?= base_url();?>/img/room/room-4.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="room-des">
                    ...
                    <div class="col-md-12 room">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="room-img">
                                    <img src="<?= base_url();?>/img/room/room-5.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="room-des">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="port-slider">
                                    <div><img src="<?= base_url();?>/img/room-slider/room-1.jpg"></div>
                                    <div><img src="<?= base_url();?>/img/room-slider/room-2.jpg"></div>
                                    <div><img src="<?= base_url();?>/img/room-slider/room-3.jpg"></div>
                                    <div><img src="<?= base_url();?>/img/room-slider/room-4.jpg"></div>
                                    <div><img src="<?= base_url();?>/img/room-slider/room-5.jpg"></div>
                                    <div><img src="<?= base_url();?>/img/room-slider/room-6.jpg"></div>
                                </div>
