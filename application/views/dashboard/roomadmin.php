                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- Form -->
                                <form method="post" action="<?= base_url('adminDakon/fungsi_tambahRoom') ?>">
                                    <?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash())   ?>
                                    <div class="mb-3">
                                        <label for="tipe_kamar" class="form-label">Tipe Kamar</label>
                                        <select name='tipekamar' class="form-select" id="tipekamar" aria-label="Default select exampel">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="nomor_ruangan" name="nomor_ruangan">
                                    </div>

                                    <div class="mb-3">
                                        <label for="status" class="form-label">Status</label>
                                        <select class="form-select" id="status" name="status" aria-label="Default select exampel">
                            ...
                            foreach ($list_kamar as $lk) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal edit -->
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editroom<?= $lk['id'] ?>">
                                            <i class="fa-solid fa-pen"></i>
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="editroom<?= $lk['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="editroom<?= $lk['id'] ?>">Edit Room <?= $tipe ?></h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <!-- form edit -->

                                                        <form method="post" action="<?= base_url('adminDakon/fungsi_editRoom/' . $lk['id']) ?>">
                                                            <?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash())   ?>
                                                            <div class="mb-3">
                                                                <label for="tipe_kamar" class="form-label">Tipe Kamar</label>
                                                                <select name='tipekamar' class="form-select" id="tipekamar" aria-label="Default select exampel">
                                                                    ...
                                                                    <option value="<?= $lk['id'] ?>"><?= $lk['nama_kamar'] ?></option>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nomor_ruangan" class="form-label">Nomor Ruangan</label>
                                                                <input type="number" class="form-control" id="nomor_ruangan" name="nomor_ruangan" value="<?= $lk['nomor_ruangan'] ?>">
                                                            </div>
                                    ...
                                    <td>
                                        <a href="<?= base_url('adminDakon/fungsi_deleteRoom/' . $lk['id']) ?>">
