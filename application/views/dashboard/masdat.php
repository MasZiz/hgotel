<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
                        ...
                        <tr>
                         ...
                         <?php foreach ($userAccess as $ua) : ?> 
                            <tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <!-- Form Edit User -->
                                                    <form method="post" action="<?= base_url('adminDakon/fungsi_editUser/' . $ua['id']) ?>">
                                ...
                                <td>
                                    <a href="<?= base_url('adminDakon/fungsi_deleteUser/' . $ua['id']) ?>">
            ...
            <a href="<?= base_url('C_Auth/reg') ?>"><button type="button" class="btn btn-primary col-md-2">Tambah User</button></a>
